...
// Fri Aug 24 18:52:09 2018 by ROOT version 5.34/36
// from TTree t1/a simple Tree with simple variables
// found on file: data/tdr_cedric.root
//////////////////////////////////////////////////////////
...
#include <TChain.h>
#include <TFile.h>
//const string filename = "highstat_150407.root";
//const string filename = "tdr_cedric.root";
//const string filename = "tdr_cedric_D87000_T322_Nrepeat2000000_Xfree1_Thick7.12_NewGeo0_.root";
//const string filename = "tdr_cedric_D87000_T322_Nrepeat2000000_Xfree1_Thick7.12_NewGeo0_0827.root";

//const string filename = "tdr_cedric_D87000_T322_Nrepeat2000000_Xfree1_Thick7.12_NewGeo0_0828_3_2.root";
const string filename = "tdr_cedric_D87000_T322_Nrepeat840000_Xfree1_Thick2.00_NewGeo1_0828_3.root";
//const string filename = "tdr_cedric_D87000_T322_Nrepeat840000_Xfree1_Thick2.00_NewGeo1_.root";
//const string filename = "tdr_cedric_D87000_T322_Nrepeat840000_Xfree1_Thick2.00_NewGeo1_0827.root";
...
public :
   ...
   Int_t           det_n;
   Int_t           det_ID[2];   //[det_n]
   Double_t        det_edep[2];   //[det_n]
   Double_t        det_edep_el[2];   //[det_n]
   Double_t        det_edep_pos[2];   //[det_n]
   Double_t        det_edep_gam[2];   //[det_n]
   Double_t        det_edep_mup[2];   //[det_n]
   Int_t           det_nsteps[2];   //[det_n]
   Double_t        det_length[2];   //[det_n]
   Double_t        det_time_start[2];   //[det_n]
   Double_t        det_time_end[2];   //[det_n]
   Double_t        det_x[2];   //[det_n]
   Double_t        det_y[2];   //[det_n]
   Double_t        det_z[2];   //[det_n]
   Double_t        det_kine[2];   //[det_n]
   Double_t        det_VrtxKine[2];   //[det_n]
   Double_t        det_VrtxX[2];   //[det_n]
   Double_t        det_VrtxY[2];   //[det_n]
   Double_t        det_VrtxZ[2];   //[det_n]
   Int_t           det_VrtxVolID[2];   //[det_n]
   Int_t           det_VrtxProcID[2];   //[det_n]
   Int_t           det_VrtxTrackID[2];   //[det_n]
   Int_t           det_VrtxParticleID[2];   //[det_n]
   Double_t        det_VvvKine[2];   //[det_n]
   Double_t        det_VvvX[2];   //[det_n]
   Double_t        det_VvvY[2];   //[det_n]
   Double_t        det_VvvZ[2];   //[det_n]
   Int_t           det_VvvVolID[2];   //[det_n]
   Int_t           det_VvvProcID[2];   //[det_n]
   Int_t           det_VvvTrackID[2];   //[det_n]
   Int_t           det_VvvParticleID[2];   //[det_n]
   Int_t           save_n;
   Int_t           save_detID[2];   //[save_n]
   Int_t           save_particleID[2];   //[save_n]
   Double_t        save_ke[2];   //[save_n]
   Double_t        save_x[2];   //[save_n]
   Double_t        save_y[2];   //[save_n]
   Double_t        save_z[2];   //[save_n]
   Double_t        save_px[2];   //[save_n]
   Double_t        save_py[2];   //[save_n]
   Double_t        save_pz[2];   //[save_n]
...
#ifdef usm_emit_cxx
usm_emit::usm_emit(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(Form("data/%s", filename.c_str()));
      if (!f || !f->IsOpen()) {
	f = new TFile(Form("data/%s",filename.c_str()));
      }
      f->GetObject("t1",tree);
...
Int_t usm_emit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t usm_emit::LoadTree(Long64_t entry)
{
...
void usm_emit::Show(Long64_t entry)
{
...
Int_t usm_emit::Cut(Long64_t entry)
{
