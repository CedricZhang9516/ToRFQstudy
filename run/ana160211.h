...
// Thu Feb 11 14:23:09 2016 by ROOT version 5.34/13
// from TTree t1/a simple Tree with simple variables
// found on file: data/musr_160211_result.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           det_n;
   Int_t           det_ID[4];   //[det_n]
   Double_t        det_edep[4];   //[det_n]
   Double_t        det_edep_el[4];   //[det_n]
   Double_t        det_edep_pos[4];   //[det_n]
   Double_t        det_edep_gam[4];   //[det_n]
   Double_t        det_edep_mup[4];   //[det_n]
   Int_t           det_nsteps[4];   //[det_n]
   Double_t        det_length[4];   //[det_n]
   Double_t        det_time_start[4];   //[det_n]
   Double_t        det_time_end[4];   //[det_n]
   Double_t        det_x[4];   //[det_n]
   Double_t        det_y[4];   //[det_n]
   Double_t        det_z[4];   //[det_n]
   Double_t        det_kine[4];   //[det_n]
   Double_t        det_VrtxKine[4];   //[det_n]
   Double_t        det_VrtxX[4];   //[det_n]
   Double_t        det_VrtxY[4];   //[det_n]
   Double_t        det_VrtxZ[4];   //[det_n]
   Int_t           det_VrtxVolID[4];   //[det_n]
   Int_t           det_VrtxProcID[4];   //[det_n]
   Int_t           det_VrtxTrackID[4];   //[det_n]
   Int_t           det_VrtxParticleID[4];   //[det_n]
   Double_t        det_VvvKine[4];   //[det_n]
   Double_t        det_VvvX[4];   //[det_n]
   Double_t        det_VvvY[4];   //[det_n]
   Double_t        det_VvvZ[4];   //[det_n]
   Int_t           det_VvvVolID[4];   //[det_n]
   Int_t           det_VvvProcID[4];   //[det_n]
   Int_t           det_VvvTrackID[4];   //[det_n]
   Int_t           det_VvvParticleID[4];   //[det_n]
   Int_t           save_n;
   Int_t           save_detID[32];   //[save_n]
   Int_t           save_particleID[32];   //[save_n]
   Double_t        save_ke[32];   //[save_n]
   Double_t        save_x[32];   //[save_n]
   Double_t        save_y[32];   //[save_n]
   Double_t        save_z[32];   //[save_n]
   Double_t        save_px[32];   //[save_n]
   Double_t        save_py[32];   //[save_n]
   Double_t        save_pz[32];   //[save_n]
...
#ifdef ana160211_cxx
ana160211::ana160211(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data/musr_160211_result.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data/musr_160211_result.root");
      }
      f->GetObject("t1",tree);
...
Int_t ana160211::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana160211::LoadTree(Long64_t entry)
{
...
void ana160211::Init(TTree *tree)
{
...
void ana160211::Show(Long64_t entry)
{
...
Int_t ana160211::Cut(Long64_t entry)
{
