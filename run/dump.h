...
// Tue Jun 17 14:35:29 2014 by ROOT version 5.34/13
// from TTree t1/a simple Tree with simple variables
// found on file: data/musr_2014.root
//////////////////////////////////////////////////////////
...
#include <TChain.h>
#include <TFile.h>
//const string fname = "acccheck3.root";
//const string fname = "150312_newSOA.root";
const string fname = "highstat_150407.root";
...
public :
   ...
   Int_t           det_n;
   Int_t           det_ID[7];   //[det_n]
   Double_t        det_edep[7];   //[det_n]
   Double_t        det_edep_el[7];   //[det_n]
   Double_t        det_edep_pos[7];   //[det_n]
   Double_t        det_edep_gam[7];   //[det_n]
   Double_t        det_edep_mup[7];   //[det_n]
   Int_t           det_nsteps[7];   //[det_n]
   Double_t        det_length[7];   //[det_n]
   Double_t        det_time_start[7];   //[det_n]
   Double_t        det_time_end[7];   //[det_n]
   Double_t        det_x[7];   //[det_n]
   Double_t        det_y[7];   //[det_n]
   Double_t        det_z[7];   //[det_n]
   Double_t        det_kine[7];   //[det_n]
   Double_t        det_VrtxKine[7];   //[det_n]
   Double_t        det_VrtxX[7];   //[det_n]
   Double_t        det_VrtxY[7];   //[det_n]
   Double_t        det_VrtxZ[7];   //[det_n]
   Int_t           det_VrtxVolID[7];   //[det_n]
   Int_t           det_VrtxProcID[7];   //[det_n]
   Int_t           det_VrtxTrackID[7];   //[det_n]
   Int_t           det_VrtxParticleID[7];   //[det_n]
   Double_t        det_VvvKine[7];   //[det_n]
   Double_t        det_VvvX[7];   //[det_n]
   Double_t        det_VvvY[7];   //[det_n]
   Double_t        det_VvvZ[7];   //[det_n]
   Int_t           det_VvvVolID[7];   //[det_n]
   Int_t           det_VvvProcID[7];   //[det_n]
   Int_t           det_VvvTrackID[7];   //[det_n]
   Int_t           det_VvvParticleID[7];   //[det_n]
   Int_t           save_n;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data/musr_2014.root");
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject( Form("data/%s", fname.c_str()));
      if (!f || !f->IsOpen()) {
	//f = new TFile("data/musr_2014_long_forKondo.root");
	f = new TFile( Form("data/%s", fname.c_str()) );
	//f = new TFile("data/musr_2014.root");
      }
      f->GetObject("t1",tree);
