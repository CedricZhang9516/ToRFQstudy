...
G4bool musrRootOutput::store_muTargetTime = true;
G4bool musrRootOutput::store_muTargetPolX = true;
G4bool musrRootOutput::store_muTargetPolY = true;
G4bool musrRootOutput::store_muTargetPolZ = true;
